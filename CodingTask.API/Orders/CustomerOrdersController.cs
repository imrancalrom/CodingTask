...
using CodingTask.Application.Orders.ChangeCustomerOrder;
using CodingTask.Application.Orders.GetCustomerOrderDetails;
using CodingTask.Application.Orders.GetCustomerOrders;
using CodingTask.Application.Orders.PlaceCustomerOrder;
using CodingTask.Application.Orders.RemoveCustomerOrder;
